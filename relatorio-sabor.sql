...
SELECT AUX1.SABOR, AUX1.ANO, (AUX1.FATURAMENTO / AUX2.TOTAL * 100) AS PERCENTUAL 
FROM
	(SELECT TP.SABOR, YEAR(NF.[DATA]) AS ANO, SUM(INF.QUANTIDADE * INF.PREÇO) AS FATURAMENTO
	FROM [ITENS NOTAS FISCAIS] INF
	INNER JOIN [TABELA DE PRODUTOS] TP
...
SELECT 
	...
	CONVERT(VARCHAR,(AUX1.FATURAMENTO / AUX2.TOTAL * 100)) + ' %' AS PERCENTUAL 
FROM
	(SELECT TP.SABOR, YEAR(NF.[DATA]) AS ANO, SUM(INF.QUANTIDADE * INF.PREÇO) AS FATURAMENTO
	FROM [ITENS NOTAS FISCAIS] INF
	INNER JOIN [TABELA DE PRODUTOS] TP
